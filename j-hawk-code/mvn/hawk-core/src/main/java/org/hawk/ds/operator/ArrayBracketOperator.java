...
@ScanMe(true)
@Opr(symbol = "[]")
public class ArrayBracketOperator extends DefaultOperator  {

    public ArrayBracketOperator() {
    }

    public ArrayBracketOperator(Operator supportedOperator) {
    ...
    public IObject operate(IObject leftObject, IObject rightObject) throws Exception {
        ...
        return  leftHawkObject.arrayBracket(rightHawkObject);
    }
}
