 ...
 * @param <Key>
 */
public class BinaryHeapOld<Key> {
    ...
    public BinaryHeapOld(Key[] keys, boolean maxHeap) {
        this.keys = keys;
        this.maxHeap = maxHeap;
    ...
    public static void main(String args[]) {
        ...
        BinaryHeapOld<Integer> minHeap = new BinaryHeapOld(a, false);
        minHeap.sort();
        minHeap.show();

        BinaryHeapOld<Integer> maxHeap = new BinaryHeapOld(a, true);
        maxHeap.sort();
        maxHeap.show();
