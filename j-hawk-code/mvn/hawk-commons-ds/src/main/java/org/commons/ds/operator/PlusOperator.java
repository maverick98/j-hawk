 ...
 */
@ScanMe(true)
@Opr(symbol = OperatorConstant.PLUS)
public class PlusOperator extends DefaultOperator{

    public PlusOperator(Operator supportedOperator) {
    ...
    public IObject operate(IObject leftObject, IObject rightObject) throws Exception {
        return leftObject.add(rightObject);
    }
}
