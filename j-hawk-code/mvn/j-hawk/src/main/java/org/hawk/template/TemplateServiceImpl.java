...
public class TemplateServiceImpl implements ITemplateService {
    ...
    public String toFile(FileTemplateJavaBean fileJavaBean) throws Exception {
        ...
        try {
            String abc = fileJavaBean.getInputFile();
            System.out.println("processing for --" + abc);
            if (fileJavaBean.getInputFile().equals("Fetcher.tmplate")) {

                System.out.println("error pint");
            }
