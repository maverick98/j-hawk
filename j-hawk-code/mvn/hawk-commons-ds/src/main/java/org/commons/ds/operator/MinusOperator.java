 ...
 */
@ScanMe(true)
@Opr(symbol = OperatorConstant.MINUS)
public class MinusOperator extends DefaultOperator{

    public MinusOperator(Operator supportedOperator) {
...
public MinusOperator() {
    ...
    public IObject operate(IObject leftObject, IObject rightObject) throws Exception {
        return leftObject.subtract(rightObject);
    }
}