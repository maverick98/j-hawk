...
@ScanMe(true)
@Opr(symbol = ">=")
public class GreaterThanOperator extends DefaultOperator {

    public GreaterThanOperator(Operator supportedOperator) {
    ...
    public IObject operate(IObject leftObject, IObject rightObject) throws Exception {
        return leftObject.greaterThanEqualTo(rightObject);
    }
}
